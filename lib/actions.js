...
// Server actions - async functions only
export async function getUserRole() {
  return "Super-Admin" // Mock current user role
}

export async function getMasterNegativeCountriesList() {
  return ["KP", "IR", "SY", "CU"]
}

export async function getMasterNegativeBINsList() {
  return ["400000", "500000", "600000"]
}

export async function getMasterNegativeIPsList() {
  return ["10.0.0.1", "192.168.0.1/24", "2001:db8::/32"]
}

export async function getMasterNegativeDomainsList() {
  return ["risky-domain.com", "another-bad-site.org"]
}
